...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, last_stride, neck, num_classes=1000,
        ...
        self._make_layer(block, 128, layers[1], stage=2, stride=2,
                                       dilate=replace_stride_with_dilation[0])
        self._make_layer(block, 256, layers[2], stage=3, stride=2,
        ...
        self._make_layer(block, 512, layers[3], stage=4, stride=last,
    ...
    def _forward(self, x, output_option='norm', chunks=3, val=False):
        print(x.requires_grad)
        x = self.conv1(x)        
        modules = [module for k, module in self._modules.items()][1]
        print("res")
        print(x.requires_grad)
