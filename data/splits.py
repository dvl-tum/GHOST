...
#DANCE
_SPLITS['dance']['train'] = {'seq': os.listdir('/storage/user/seidensc/datasets/DanceTrack/train'), 'dir': 'train'}
_SPLITS['dance']['val'] = {'seq': os.listdir('/storage/user/seidensc/datasets/DanceTrack/val'), 'dir': 'val'}
_SPLITS['dance']['test'] = {'seq': os.listdir('/storage/user/seidensc/datasets/DanceTrack/test'), 'dir': 'test'}
