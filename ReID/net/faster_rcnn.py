...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 # add additional embedding head
                 additional_embedding=False,
                 num_ids=100,
...
class FastRCNNPredictor(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, additional_embedding, num_ids):
...
def fasterrcnn_resnet50_fpn(pretrained=False, progress=True, additional_embedding=False, num_ids=100,
    ...
    model = FasterRCNN(backbone, num_classes, additional_embedding=True, num_ids=num_ids) #**kwargs
    if pretrained:
